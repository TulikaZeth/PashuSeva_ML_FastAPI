    ...
    async def execute(self, task: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if task == "predict_amr_risk":
                ...
                # Map internal analysis to response schema
                amr_level = None
                if 'risk_category' in risk_analysis:
                    # keep legacy field
                    amr_level = risk_analysis['risk_category']
                ...
                response = RiskPredictionResponse(
                    ...
                    amr_risk_level=amr_level,
                    risk_category=risk_analysis.get("risk_category"),
                    risk_score=float(risk_analysis.get("overall_risk_score", 0.0)),
