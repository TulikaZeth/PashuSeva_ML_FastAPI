...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Expose AMU agent to amu_routes module so API endpoints can call it
        from backend.api import amu_routes
        amu_routes.set_amu_agent(amu_agent)
        ...
        # Set MRL agent in MRL routes
        from backend.api import mrl_routes
        mrl_routes.set_mrl_agent(mrl_agent)
